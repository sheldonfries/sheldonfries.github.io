...
<table class="table table-striped table-bordered" id="skaterTable" cellspacing="0">
	<thead>
		<tr>
			<th>#</th>
			<th>Name</th>
	...
	<tbody>
			...
			foreach ($positions as $position)
        {
            ...
            print("<td>" . $position["goals"] . "</td>");
            print("<td>" . $position["assists"] . "</td>");
            print("<td>" . $position["points"] . "</td>");
            print("<td>" . $position["pims"] . "</td>");
